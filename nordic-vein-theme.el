...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-property-name-face ((,class (:foreground "#7aa2f7"))))
   `(font-lock-property-use-face ((,class (:foreground "#7aa2f7"))))
   `(font-lock-string-face ((,class (:foreground ,safe))))   
   `(font-lock-type-face ((,class (:foreground ,safe))))
   `(font-lock-variable-name-face ((,class (:foreground "#7aa2f7"))))
